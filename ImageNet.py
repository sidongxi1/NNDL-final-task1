...
def linear_evaluation(epochs, batch_size, learning_rate):
    ...
    writer = SummaryWriter(f'/runs/imagenet')
    ...
    for epoch in tqdm(range(epochs)):
        ...
        if epoch == epochs - 1:
            torch.save(base_model, f'../model/imagenet_model_epoch_{epoch}.pth')
            torch.save(base_model.state_dict(), f'../model/imagenet_state_dict_epoch_{epoch}.pth')

    writer.close()

if __name__ == "__main__":
    linear_evaluation(50, 256, 0.01)
